...
esp_codec_dev_handle_t bsp_audio_codec_speaker_init(void)
{
    ...
    ESP_LOGI(TAG, "Creating I2C control interface for ES8311 codec with port: %d", i2c_port);
...
esp_codec_dev_handle_t bsp_audio_codec_microphone_init(void)
{
    ...
    ESP_LOGI(TAG, "Creating I2C control interface for ES7210 codec with port: %d", i2c_port);
    audio_codec_i2c_cfg_t i2c_cfg = {
        .port = i2c_port,
        .addr = 0x82,
    };
