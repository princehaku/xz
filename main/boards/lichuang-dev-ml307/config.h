...
//   ML307R PIN2 (GND)  ----> J2 Pin5 (GND)
//   ML307R PIN3 (TXD)  ----> J2 Pin2 (IO10 / GPIO10)  ← ESP32 接收
//   ML307R PIN4 (RXD)  ----> J2 Pin1 (IO11 / GPIO11)  ← ESP32 发送
//   ML307R PIN5 (EN)   ----> 悬空（默认上拉自动使能）
#define ML307_TX_PIN GPIO_NUM_11  // ESP32 发送 -> 接 ML307R RXD (J2 Pin1 / IO11)
#define ML307_RX_PIN GPIO_NUM_10  // ESP32 接收 -> 接 ML307R TXD (J2 Pin2 / IO10)
